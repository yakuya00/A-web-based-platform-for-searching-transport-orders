...
export declare const sql: import("@slonik/sql-tag").SqlTag<Record<PropertyKey, import("@standard-schema/spec").StandardSchemaV1<unknown, unknown>>>;
...
export type { ClientConfiguration, ClientConfigurationInput, CommonQueryMethods, Connection, ConnectionOptions, ConnectionRoutine, DatabaseConnection, DatabasePool, DatabasePoolConnection, DatabasePoolEventEmitter, DatabaseTransactionConnection, DatabaseTransactionEventEmitter, Field, IdentifierNormalizer, Interceptor, MaybePromise, PoolContext, Query, QueryContext, QueryFunction, QueryResult, QueryResultRow, QueryResultRowColumn, TypeNameIdentifier, ValueExpression, } from './types.js';
