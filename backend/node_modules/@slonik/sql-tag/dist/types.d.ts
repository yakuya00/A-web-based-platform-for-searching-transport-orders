...
export type QuerySqlToken<T extends StandardSchemaV1 = StandardSchemaV1<any, any>> = {
    readonly parser: T;
    readonly sql: string;
...
export type SqlTag<Z extends Record<string, StandardSchemaV1> = Record<string, StandardSchemaV1>> = {
    ...
    type: <Y extends StandardSchemaV1>(parser: Y) => (template: TemplateStringsArray, ...values: ValueExpression[]) => QuerySqlToken<Y>;
