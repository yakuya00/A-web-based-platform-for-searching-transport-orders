...
export type DatabaseTransactionConnection = CommonQueryMethods & DatabaseTransactionEventEmitter & {
    readonly transactionDepth: number;
    readonly transactionId: string;
};
export type DatabaseTransactionEventEmitter = StrictEventEmitter<EventEmitter, {
    commit: (event: {
...
export type Interceptor = {
    ...
    readonly dataIntegrityError?: (queryContext: QueryContext, query: Query, error: DataIntegrityError, result: QueryResult<QueryResultRow>) => MaybePromise<null>;
    readonly name: string;
    ...
    readonly transformRowAsync?: (queryContext: QueryContext, query: Query, row: QueryResultRow, fields: readonly Field[]) => Promise<QueryResultRow>;
};
export type InternalNestedTransactionFunction = <T>(log: Logger, connection: ConnectionPoolClient, clientConfiguration: ClientConfiguration, handler: TransactionFunction<T>, transactionDepth: number, transactionRetryLimit?: number, eventEmitter?: DatabaseTransactionEventEmitter, transactionId?: string) => Promise<T>;
export type InternalQueryMethod<R = any> = (log: Logger, connection: ConnectionPoolClient, clientConfiguration: ClientConfiguration, slonikSql: QuerySqlToken, uid?: QueryId, integrityValidation?: IntegrityValidation) => R;
...
export type InternalTransactionFunction = <T>(log: Logger, connection: ConnectionPoolClient, clientConfiguration: ClientConfiguration, handler: TransactionFunction<T>, transactionRetryLimit?: number, eventEmitter?: DatabaseTransactionEventEmitter, transactionId?: string) => Promise<T>;
...
export type QueryFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<QueryResult<StandardSchemaV1.InferOutput<T>>>;
...
type QueryAnyFirstFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<ReadonlyArray<StandardSchemaV1.InferOutput<T>[keyof StandardSchemaV1.InferOutput<T>]>>;
type QueryAnyFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<ReadonlyArray<StandardSchemaV1.InferOutput<T>>>;
type QueryExistsFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<boolean>;
type QueryManyFirstFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<ReadonlyArray<StandardSchemaV1.InferOutput<T>[keyof StandardSchemaV1.InferOutput<T>]>>;
type QueryManyFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<ReadonlyArray<StandardSchemaV1.InferOutput<T>>>;
type QueryMaybeOneFirstFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<null | StandardSchemaV1.InferOutput<T>[keyof StandardSchemaV1.InferOutput<T>]>;
type QueryMaybeOneFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<null | StandardSchemaV1.InferOutput<T>>;
type QueryOneFirstFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<StandardSchemaV1.InferOutput<T>[keyof StandardSchemaV1.InferOutput<T>]>;
type QueryOneFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, values?: PrimitiveValueExpression[]) => Promise<StandardSchemaV1.InferOutput<T>>;
type StreamFunction = <T extends StandardSchemaV1>(sql: QuerySqlToken<T>, streamHandler: StreamHandler<StandardSchemaV1.InferOutput<T>>) => Promise<StreamResult>;
