...
export const bindPool = (events, parentLog, pool, clientConfiguration) => {
    const boundPool = {
        any: async (query) => {
            return await createConnection(parentLog, pool, clientConfiguration, 'IMPLICIT_QUERY', async (connectionLog, connection, boundConnection) => {
        ...
        connect: async (connectionHandler) => {
            return await createConnection(parentLog, pool, clientConfiguration, 'EXPLICIT', async (connectionLog, connection, boundConnection) => {
        ...
        transaction: async (transactionHandler, transactionRetryLimit) => {
            return await createConnection(parentLog, pool, clientConfiguration, 'IMPLICIT_TRANSACTION', async (connectionLog, connection) => {
