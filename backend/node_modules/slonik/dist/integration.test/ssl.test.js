...
test('makes a connection using SSL', async (t) => {
    ...
    try {
        ...
        searchParameters.set('sslrootcert', fileURLToPath(import.meta.resolve('@slonik/test-ssls/root.crt')));
        searchParameters.set('sslcert', fileURLToPath(import.meta.resolve('@slonik/test-ssls/slonik.crt')));
        searchParameters.set('sslkey', fileURLToPath(import.meta.resolve('@slonik/test-ssls/slonik.key')));
        const pool = await createPool(`postgresql://postgres@localhost:${servicePort}/postgres?${searchParameters}`);
