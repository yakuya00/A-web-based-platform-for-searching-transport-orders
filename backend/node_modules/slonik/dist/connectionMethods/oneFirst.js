 ...
 */
export const oneFirst = async (log, connection, clientConfiguration, slonikSql, inheritedQueryId) => {
    ...
    if (keys.length > 1) {
        ...
        throw new UnexpectedStateError('Expected query to return one result, but received multiple results.');
    }
    return row[keys[0]];
};
