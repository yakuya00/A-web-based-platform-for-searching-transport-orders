...
export const bindPoolConnection = (parentLog, connection, clientConfiguration) => {
    return {
        any: (slonikSql) => {
        ...
        exists: async (slonikSql) => {
            return await exists(parentLog, connection, clientConfiguration, slonikSql);
        },
        many: (slonikSql) => {
        ...
        stream: async (slonikSql, streamHandler) => {
            return await stream(parentLog, connection, clientConfiguration, slonikSql, streamHandler, undefined);
        },
        transaction: async (handler, transactionRetryLimit) => {
            return await transaction(parentLog, connection, clientConfiguration, handler, transactionRetryLimit);
        },
    };
};
